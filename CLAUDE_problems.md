...
---
## P050 [GENERAL] -- Output Report Docs Kept Describing It as a Blocked "PPTX, No Template" Item for ~5 Hours After a Real HTML-to-PDF Mockup Had Already Been Built (2026-08-28)
...
**Cross-references:** P047 (same root pattern -- a stale claim in a Key Decisions Log entry, never re-checked against the real source, read as settled). The `infra/README.md` staleness fixed earlier today alongside the P048/deploy work (a smaller instance of the same thing).
