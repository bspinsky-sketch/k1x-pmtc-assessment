...
---
## P052 [GENERAL] -- Two Already-Documented STANDING_RULES.md Rules Ignored All Session: the AskUserQuestion Picker and Em Dashes (2026-08-28)
...
**Cross-references:** None -- this is the first purely behavioral (not code/data) entry in this file, but it follows the same "documented, then not re-checked" shape as P047, P050, and P051.
